...
//阻止点击隐藏方法
$("#txt_login_code_rt,#show_secode_menu_content_login").click(function(e) {
	e.stopPropagation();
});
var hidecode = function() {
	if (!$("#show_secode_menu_content_login").is(".hidden")) {
		$("#show_secode_menu_content_login").addClass("hidden");
	}
}
