$.fn.extend({
	jselect:function(){
		return $(this).each(function(){
			...
			var _this=$(this);
			_this.after("<input type=\"hidden\" /><div class='jslct'><div class='jslct_t'><em></em></div><dl></dl></div>");
			...
			var em = $("em",lst);
			var fn_change=_this.attr("onchange");
			...
			itm.click(function(){
			   if(fn_change!=null){_this.trigger("change", true);}
