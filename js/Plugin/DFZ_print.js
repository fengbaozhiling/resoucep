...
forSPrint.data ={
	...
	artSourceHtml:"http://www.sina.com.cn",	//初始显示的art_source
...
forSPrint.GetPageInitInfo = function() {
	...
	var pageNode2 = document.getElementById("artibody");
	var ps = pageNode2.getElementsByTagName("p");
...
<span class='pagebox_next'><a href='http://news.sina.com.cn/c/p/2008-05-26/174015621792.shtml'>下一页</a></span>
	...
	}else if(pageNode2&&ps.length!=0){
		var p_page = ps[ps.length-1];
		for(var j=0,psl=ps.length;j<psl;j++){
			if(ps[j].className == "page"){
				p_page = ps[j];
			}
		}
		var hrefPattern2 = /(<a\shref=[\"\']?[^>]*?[\"\']?>\d+<\/a>)|(<span\sclass=[\"\']?cur[\"\']?>\d+<\/span>)/ig;
		html = p_page.innerHTML;
		if(hrefStrArray = html.match(hrefPattern2)){
			for(var i = 0 ; i < hrefStrArray.length; i ++)
			{
				//daichang 201210251603 edited "i" > "g"
				var re = new RegExp("<a href=[\"\'](.*?)[\"\']>[0-9]+<\/a>","g");
...
forSPrint.Print = function(){
	...
	//有两类样式，一个媒体样式一个打印样式，记得新样式都得加上
	//新加样式 201209101536 daichang added
	var new_style = [];
	new_style.push('em{font-style:normal;}');
	//左下角视频
	new_style.push( 'div.blk_video_news{width:315px;float:left;}' +'\n'+
		'div.blk_video_news .play_icon{display:none;}' +'\n'+
		'div.blk_video_news h3{margin-top:5px;font-size:14px;font-weight:normal;}' +'\n'+
		'#PriCon div.blk_video_news p{margin:5px 0 0 0;}');
	//高清图
	new_style.push('div.hdFigureWrap{margin:0 0 20px 0;}' +'\n'+
		'div.hdfigurewrap .figuretablediv{height:auto;}' +'\n'+
		'div.hdfigurewrap .figuretablediv table{height:auto;}');
	//普清图
	new_style.push('div.sdfigurewrap .figuretablediv{height:auto;border:none;}' +'\n'+
		'div.sdfigurewrap .figuretablediv table{height:auto;}' +'\n'+
		'#PriCon .sdfigurewrap .thumb_contentDiv{display:none ! important;}' +'\n'+
		'#PriCon .sdfigurewrap .figDescription{padding:0;}' +'\n'+
		'#PriCon .sdfigurewrap .figDescription p{margin:0;padding:10px 0;}' +'\n'+
		'#PriCon .sdFigureWrap .figureTableDiv{border:0 ! important;}');

	//视频轮播
	new_style.push('#PriCon .a-p-s-img img{border:0;}');
	//图片小点大
	new_style.push('#PriCon .artical-album-wrap .a-a-desc{margin:0;}' +'\n'+
		'#PriCon .artical-album-wrap img{border:none;vertical-align:middle;}');
	//打印隐藏图片时也隐藏某些模块，如视频轮播，图片小点大
	new_style.push('#PriCon.noImg .artical-album-wrap{display:none ! important;}' +'\n'+
		'#PriCon .artical-player-wrap .a-p-s-txt{margin:0;height:20px;line-height:20px;}' +'\n'+
		'#PriCon.noImg .artical-player-wrap{display:none ! important;}');
	//健康
	new_style.push('.hc_left{float:left;margin: 0 10px 0 0;}');
	...
	var info =	"<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">"	+"\n"+
		...
		".pb,.otherContent_01,.sv_cont_c14{display:none !important;}" + "\n"+
		...
		".img_wrapper img{padding: 8px; border-color:#ccc!important;}"	+"\n"+
		".img_table_wraper { border:solid 1px #ff6666; background:#fff;padding:1px;width:544px; margin:0 auto;text-align:center}"	+"\n"+
		".img_table_wraper table,.img_table_wraper td{border:none 0;border-spacing:0;border-collapse:collapse;}"	+"\n"+
		".img_table_wraper td {background:#ffd2d2;}"	+"\n"+
		".img_table_wraper td img {margin:7px auto; display:block }"	+"\n"+
		".img_table_wraper td a:hover img{border-color:#c00}"	+"\n"+
		".img_table_wraper td span{background:#fff; padding:3px 0; margin:0 auto;display:block;text-align:center;font-size:12px;}"	+"\n"+
		new_style +"\n"+
		"</style>"	+"\n"+
		"<!--[if IE]>"	+"\n"+
		"<style type=\"text/css\" media=\"screen\">"	+"\n"+
		...
		".img_table_wraper td a:hover img{border-color:#c00}"	+"\n"+
		".img_table_wraper td span{background:#fff; padding:3px 0;margin:0 auto;display:block;text-align:center;font-size:12px;}"	+"\n"+
		".contPic{width:160px;float:left;padding:5px 25px 10px 0;position:relative;text-align:center;*zoom:1;clear:both;}"	+"\n"+
		".contPic .ct_txt{display:block;line-height:20px;font-size:12px;line-height:22px\\9;overflow:hidden;margin-top:-20px;color:#e4e4e4;height:20px;cursor:pointer;filter: progid:DXImageTransform.Microsoft.gradient(GradientType = 0,startColorstr = '#80000000', endColorstr = '#80000000' )\\9;background-color:rgba( 0, 0, 0, .5 );background-color:transparent\\9;position:relative;}"	+"\n"+
		".contPic a:link,.contPic a:visited{color:#e4e4e4;text-decoration:none;}"	+"\n"+
		".contPic a:hover{color:#fff;text-decoration:none;}"	+"\n"+
		".contPic a:hover .ct_txt{color:#fff;}"	+"\n"+
		".contPic .play_icon{top:77px;}"	+"\n"+
		".play_icon {position:absolute; width:22px; height:22px; top:52px; left:5px; cursor:pointer; background:url(http://i0.sinaimg.cn/ent/deco/2012/0517/ent_zxh_0420_video_play_icon.png) no-repeat; _filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true,sizingMethod=scale, src='http://i0.sinaimg.cn/ent/deco/2012/0517/ent_zxh_0420_video_play_icon.png');_background:none;}"	+"\n"+
		"a:hover .play_icon {background:url(http://i3.sinaimg.cn/ent/deco/2012/0517/ent_zxh_0420_video_play_icon_h.png) no-repeat; _filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true,sizingMethod=scale, src='http://i3.sinaimg.cn/ent/deco/2012/0517/ent_zxh_0420_video_play_icon_h.png');_background:none;}"	+"\n"+
		"</style>"	+"\n"+
		...
		"<body>"	+"\n"+
		"<center>"	+"\n"+
		"  <table width=\"600\" cellspacing=\"0\" id=\"NoPrinter1\" style=\"border-bottom:1px #DDD9D3 solid;\" align=\"center\">"	+"\n"+
		...
		"          </tr>"	+"\n"+
		"        </table></td>"	+"\n"+
		"      <td width=\"90\"><a href=\"javascript:sPrint.Print();\"><img src=\"http://i0.sinaimg.cn/bb/article/con_pri_ws_001.gif\" width=\"80\" height=\"20\" alt=\"打印此页面\"/></a></td>"	+"\n"+
		"      <td width=\"65\"><a href=\"###\" id=\"btnExit1\"><img src=\"http://i1.sinaimg.cn/bb/article/con_pri_ws_002.gif\" width=\"64\" height=\"20\" alt=\"返回正文页\"/></a></td>"	+"\n"+
		"    </tr>"	+"\n"+
		"  </table>"	+"\n"+
		...
		"        </table></td>"	+"\n"+
		"      <td width=\"90\"><a href=\"javascript:sPrint.Print();\"><img src=\"http://i0.sinaimg.cn/bb/article/con_pri_ws_001.gif\" width=\"80\" height=\"20\" alt=\"打印此页面\"/></a></td>"	+"\n"+
		"      <td width=\"65\"><a href=\"###\" id=\"btnExit2\"><img src=\"http://i1.sinaimg.cn/bb/article/con_pri_ws_002.gif\" width=\"64\" height=\"20\" alt=\"返回正文页\"/></a></td>"	+"\n"+
		"    </tr>"	+"\n"+
		"  </table>"	+"\n"+
		"</center>"	+"\n"+
		"<!-- print dialog start -->"	+"\n"+
		...
		"	//将该内容插入到页面前进行过滤"	+"\n"+
		"	sPrint.priConNode.innerHTML += sPrint.HandlerBodyHtml(frames[\'iframeForData\'].document.getElementById(sPrint.data.artiBodyId).innerHTML.replace(\/<div class=\"article-video.*?div>\/g,''));//iframe 页里也有GetObj 函数"	+"\n"+
		//090525001 ws begin
		//每次载入分页数据时，都将播放器干掉
		...
		"	strTmp = strTmp.replace(/<p\\s+class=[\"']?page[\"']?>[\\s\\S]*/i, \"\");"+"\n"+
		"	strTmp = strTmp.replace(/<div\\s+[^>]*class=[\"']?blkComment\\s+otherContent_01[\"']?>[\\s\\S]*/i, \"\");"+"\n"+
		"	strTmp = strTmp.replace(/<div[^>]*><iframe[^>]*?id=[\"']?ipylcf[\\s\\S]*/i, \"\");"+"\n"+
		"	strTmp = strTmp.replace(/<div\\s+[^>]*id=[\"']?sinashareto[\"']?[\\s\\S]*/i, \"\");"+"\n"+
		"	strTmp = strTmp.replace(/<div\\s+[^>]*id=[\"']?slideTJ[\"']?[\\s\\S]*/i, \"\");"+"\n"+
		...
		"	}"	+"\n"+
		"}"	+"\n"+
		"document.getElementById(\"btnExit1\").href=location.href.split('#')[0];" + "\n" +
		"document.getElementById(\"btnExit2\").href=location.href.split('#')[0];" + "\n" +
