...
.loginform { padding:10px; float:left; width:390px; border-right:1px solid #e9e9e9;}
...
.winbody { background:#fff; width:920px; position:relative;}
...
<div class="winbody simple_style">
	...
	<div class="pad30 clearfix">
		...
		<div class="nologinrl f_l">
			<form action="" method="post" id="" name="">
			<h3 class="mb_10">无需账号，直接发布任务</h3>
			<div class="rowElem">
				<label class="txt pl_20"><strong>手机号码：</strong> </label>
				<input class="txt_input"  type="text"  size="20"  tmp="" autocomplete="off" name="" limit="required:true" msg="手机号码不得为空" value=""  msgArea="span_msg_tip" />
			</div>
			<div class="rowElem">
				<a class="yazhenma" href="">获取验证码</a>
				<input class="txt_input" style="width:80px;"  type="text"  size="20"  tmp="" autocomplete="off" name="" limit="required:true" msg="验证码" value=""  msgArea="span_msg_tip" />&nbsp;&nbsp;<span class="c999">验证码将发送到您的手机</span>
			</div>
			<div class="rowElem">
				<label class="txt pl_20"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong> </label>
				<button class="button" type="button" onclick="return user_login();" style=" "><span class="buttoniner"><strong class="c333 font14">直接发布</strong></span></button>
			</div>
			</form>
		</div>
	</div>
