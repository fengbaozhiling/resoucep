			...
			<div class="box">
				...
				<div class="inerul clearfix">
					<ul class="clearfix">
						...
						<li>
							<a class="crent" href="http://www.epweike.net/help-view-get_password-ct-password.html" original-title="">找回登录密码</a>
						</li>
						<li>
			...
			<div class="box">
				...
				<div class="pad20">
					<div class="clearfix mb_10">
						...
						<h2 class="clearfix">找回登录密码</h2>
						<p class="mt_5 c999">忘记登录密码，请使用邮箱、手机或客服人工方式找回。</p>
					</div>
					<div class="bd_t">
						<div class="submitwork clearfix mt_10 border_n">
							<form action="index.php?do=help&view=get_password&step=1" method="post" id="get_form" name="get_form" class="mb_30" onsubmit="return false;return checkForm(document.getElementById('get_form'),false);">
								<input type="hidden" name="formhash" id="formhash" value="525a72">
